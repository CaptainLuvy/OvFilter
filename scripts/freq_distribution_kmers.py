...
def write_histo_to_xcel_get_lower_upper(input, output):
    ...
    while no_of_kmers[start_index]/no_of_kmers[start_index+1] > 1.25:
        start_index += 1
    # while start_index+3 < len(no_of_kmers):
    #     ratio1 = no_of_kmers[start_index]/no_of_kmers[start_index+1]
    #     ratio2 = no_of_kmers[start_index+1]/no_of_kmers[start_index+2]
    #     ratio3 = no_of_kmers[start_index+2]/no_of_kmers[start_index+3]
    #     if ratio1 <= 1.25 and ratio2 <= 1.25 and ratio3 <= 1.25:
    #         break
    #     start_index += 1
